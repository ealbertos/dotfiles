...
export { ResultP, allOk, allOkAsync, attempt, either, error, errorDo, errorDoAsync, errorOrThrow, errorReplace, errorRescue, errorRescueAsync, errorThen, firstOk, isError, isOk, isResult, ok, okChain, okChainAsync, okDo, okDoAsync, okOrThrow, okReplace, okThen, parseJson, promiseToResult, resultToBoolean, resultify };
