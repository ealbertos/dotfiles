...
var resultAsync = require('result-async');
var fs = require('fs');
...
var alternatePathForSide = function (pathPattern, alternatePattern, filePath, projectionsPath) {
    ...
    if (resultAsync.isError(matchResult))
        return null;
...
var matchPatternToPath = function (pathPattern, filePath) {
    ...
    if (!matches || !matches[2])
        return resultAsync.error(null);
    var pathMatches = matches.slice(1);
    return resultAsync.ok(pathMatches);
};
/**
...
var combinePaths = function (projectionsPath, filePattern) {
    var projectionsDir = path.dirname(projectionsPath);
 ...
 */
var findFileFrom = function (fileName) { return function (fromFilePath) { return __awaiter(void 0, void 0, resultAsync.ResultP, function () {
    var filePath;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                filePath = _a.sent();
                return [2 /*return*/, filePath ? resultAsync.ok(filePath) : resultAsync.error("file not found")];
        }
    });
}); }; };
/**
...
function makeFile(filePath, contents) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            // prettier-ignore
            return [2 /*return*/, pipeA(filePath)(makeDirectoryForFile)(resultAsync.okChainAsync(makeFileShallow(contents)))
                    .value];
        });
    });
}
...
var makeFileShallow = function (contents) { return function (filePath) {
    // prettier-ignore
    return pipeA(writeFile(filePath, contents, { flag: "wx" }))(resultAsync.errorReplace(filePath + " already exists"))(resultAsync.okReplace(filePath))
        .value;
}; };
function makeDirectoryDeep(dirPath) {
    return __awaiter(this, void 0, resultAsync.ResultP, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, mkdir(dirPath, { recursive: true })];
                case 1:
                    _a.sent();
                    return [2 /*return*/, resultAsync.ok(dirPath)];
            }
        });
    });
}
 ...
 */
var findExisting = function (filePaths) { return __awaiter(void 0, void 0, resultAsync.ResultP, function () {
    return __generator(this, function (_a) {
        // prettier-ignore
        return [2 /*return*/, pipeA(filePaths)(map(fileExists))(function (files) { return Promise.all(files); })(function (file) { return resultAsync.firstOk(file); })(resultAsync.errorThen(always(filePaths)))
                .value];
    });
}); };
/**
 ...
 */
var fileExists = function (filePath) { return __awaiter(void 0, void 0, resultAsync.ResultP, function () {
    return __generator(this, function (_a) {
        // prettier-ignore
        return [2 /*return*/, pipeA(access(filePath, fs.constants.R_OK))(resultAsync.okReplace(filePath))(resultAsync.errorReplace(filePath))
                .value];
    });
}); };
function ls(directoryPath) {
    return __awaiter(this, void 0, resultAsync.ResultP, function () {
        return __generator(this, function (_a) {
            // prettier-ignore
            return [2 /*return*/, pipeA(directoryPath)(readdir)(resultAsync.errorReplace(directoryPath + " not found"))
                    .value];
        });
    });
}
...
var parseJson = function (data, fileName) {
    try {
        return resultAsync.ok(JSON.parse(data));
    }
    catch (e) {
        var message = "Couldn't parse " + (fileName || "file") + ": " + e.message;
        return resultAsync.error(message);
    }
};
/**
...
function makeDirectoryForFile(filePath) {
    return __awaiter(this, void 0, resultAsync.ResultP, function () {
        return __generator(this, function (_a) {
            // prettier-ignore
            return [2 /*return*/, pipeA(filePath)(path.dirname)(makeDirectoryDeep)(resultAsync.okReplace(filePath))
                    .value];
        });
    });
}
 ...
 */
var fsReadFile = resultAsync.resultify(util.promisify(fs.readFile));
var mkdir = resultAsync.resultify(util.promisify(fs.mkdir));
var writeFile = resultAsync.resultify(util.promisify(fs.writeFile));
var access = resultAsync.resultify(util.promisify(fs.access));
var unlink = resultAsync.resultify(util.promisify(fs.unlink));
var readdirP = util.promisify(fs.readdir);
var readdir = resultAsync.resultify(function (path) { return readdirP(path); });
 ...
 */
var findAlternateFile = function (userFilePath) { return __awaiter(void 0, void 0, resultAsync.ResultP, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                result = _a.sent();
                if (!resultAsync.isOk(result)) {
                    return [2 /*return*/, resultAsync.error({
                            message: "No " + projectionsFilename + " found as a parent of " + userFilePath,
                            startingFile: userFilePath
                        })];
                }
                projectionsPath = result.ok;
                normalizedUserFilePath = path.resolve(userFilePath);
                return [2 /*return*/, pipeA(projectionsPath)(readProjections)(resultAsync.okThen(projectionsToAlternatePatterns))(resultAsync.okChainAsync(alternatePathIfExists(normalizedUserFilePath, projectionsPath))).value];
        }
    });
}); };
/**
 ...
 *
 */
var findOrCreateAlternateFile = function (userFilePath) { return __awaiter(void 0, void 0, resultAsync.ResultP, function () {
    var onError;
    return __generator(this, function (_a) {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (alternatesAttempted.length === 0) {
                            return [2 /*return*/, resultAsync.error(__assign(__assign({}, err), { message: "Couldn't create an alternate file for '" + userFilePath + "': it didn't match any known patterns." }))];
                        }
                        newAlternateFile = alternatesAttempted[0];
                        _a = resultAsync.either;
                        return [4 /*yield*/, makeFile(newAlternateFile)];
                    case 1: return [2 /*return*/, _a.apply(void 0, [_b.sent(),
                            always$1(resultAsync.ok(newAlternateFile)),
                            always$1(resultAsync.error(__assign(__assign({}, err), { message: "Couldn't create file " + newAlternateFile })))])];
                }
            });
        }); };
        // prettier-ignore
        return [2 /*return*/, pipeA(userFilePath)(findAlternateFile)(resultAsync.errorRescueAsync(onError))
                .value];
    });
}); };
/**
 ...
 */
var readProjections = function (projectionsPath) { return __awaiter(void 0, void 0, resultAsync.ResultP, function () {
    return __generator(this, function (_a) {
        // prettier-ignore
        return [2 /*return*/, pipeA(projectionsPath)(readFile)(resultAsync.okThen(function (data) { return (data === "" ? "{}" : data); }))(resultAsync.okChain(function (x) { return parseJson(x, projectionsPath); }))(resultAsync.errorThen(function (err) { return ({
...
var alternatePathIfExists = function (userFilePath, projectionsPath) { return function (patterns) {
    ...
    // prettier-ignore
    return pipeA(patterns)(possibleAlternatePaths)(removeFailedLookups)(findExisting)(resultAsync.errorThen(function (alternatesAttempted) { return ({
...
var sampleProjectionsDirectory = path.resolve(__dirname, "../sample-projections");
/**
...
function initializeProjections(currentPath, frameworkName) {
    return __awaiter(this, void 0, resultAsync.ResultP, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    projectionsPath = path.resolve(currentPath, projectionsFilename);
                    _a = resultAsync.isOk;
                    return [4 /*yield*/, fileExists(projectionsPath)];
                case 1:
                    if (_a.apply(void 0, [_b.sent()])) {
                        return [2 /*return*/, resultAsync.error(projectionsPath + " already exists!")];
                    }
                    // prettier-ignore
                    return [2 /*return*/, pipeA(frameworkName)(sampleFileName)(fileExists)(resultAsync.errorReplace("sorry, " + frameworkName + " doesn't have a default projections file yet."))(resultAsync.okChainAsync(readFile))(resultAsync.okChainAsync(function (contents) { return makeFile(projectionsPath, contents); }))
                            .value];
            }
        });
    });
...
function possibleFrameworks() {
    return __awaiter(this, void 0, resultAsync.ResultP, function () {
        return __generator(this, function (_a) {
            // prettier-ignore
            return [2 /*return*/, pipeA(sampleProjectionsDirectory)(ls)(resultAsync.okThen(map(frameworkFromSampleFilename)))(resultAsync.okThen(frameworkNamesToTitlePair))
                    .value];
        });
    });
}
...
function sampleFileName(framework) {
    ...
    return path.resolve(sampleProjectionsDirectory, "projections" + frameworkNamePart + ".json");
}
...
exports.findAlternateFile = findAlternateFile;
exports.findOrCreateAlternateFile = findOrCreateAlternateFile;
exports.initializeProjections = initializeProjections;
exports.isAlternateFileNotFoundError = isAlternateFileNotFoundError;
exports.possibleFrameworks = possibleFrameworks;
//# sourceMappingURL=alternate-file.cjs.js.map
