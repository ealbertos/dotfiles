...
const RegexHelpers = require("../helper/regex");
const transformation_1 = require("./transformation");
class CompletionProvider {
    constructor(documentation, triggerWord, disableTriggerWordAutoClearPatterns, insertionTemplates) {
        ...
        this.disableTriggerWordAutoClearRegexp = disableTriggerWordAutoClearPatterns.map(pattern => glob_1.globPatternToRegExp(pattern));
    ...
    provideCompletionItems(document, position, token, context) {
        ...
        const insertionTemplate = transformation_1.InsertionTemplate.resolve(document, this.insertionTemplates);
